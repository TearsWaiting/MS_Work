...
public class LockedText extends JFrame implements ActionListener, DocumentListener {
	// 声明变量
	// 菜单条
	JMenuBar menuBar;
	...
	int i = 1;
	JButton[] container1 = {null,jb1,jb2,jb3,jb4,jb5,jb6,jb7,jb8,jb9,jb10};
	JTextArea[] container2 = {null,jt1,jt2,jt3,jt4,jt5,jt6,jt7,jt8,jt9,jt10};
...
//问题-------------------------------------------------------------------------
//为什么把变量声明放到一个方法中会出错，因为不是在类体中了
//接口，抽象类理解
//open方法,append(bfr.read:ine())为什么不行
//为什么文件内容无故消失,bfw.flush()的作用
//为什么换行符消失
//
//要学会的新知识
